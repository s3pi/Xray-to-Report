## Read Me ##
# Step 1
# CRFENet+Dense(15) is trained on NIHCC data and weights "CRFENET_NIH.h5" are saved.
# CRFENet can be found in ../Networks/CRFENet.py
        ...
        for batch_num in range(num_of_batches):
            ...
            if batch_count == 100:
                ...
                if per_epoch_test_loss < min_loss:
                    ...
                    model.save_weights(model_weights_path + '/model_' + str(test_e)+'.h5') # best model weight is named CRFENET_NIH.h5 and is saved in Model_Weights.
